    ...
    <div className="section">
      <div id="about">
        <div id="about--content">
          <h1>About</h1>
          <p>
            I started my professional career as an engineer in the construction
            industry. Working on various projects gave me valuable experience in
            problem-solving, attention to detail, and the ability to manage
            complex tasks. However, my passion for technology and coding
            eventually led me to transition into a new career as a full stack
            web developer.
          </p>
          ...
          <p>
            ...
            coding bootcamp, which was a major accomplishment for me. I have
            also completed 4 certifications from{" "}
            <a
