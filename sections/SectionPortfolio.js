...
const portfolioCards = [
    ...
    { id: 5, name: 'PortfolioWebsite', tech: ['react', 'javascript', 'next.js'] },
    { id: 6, name: 'Spotify', tech: ['javascript'] },
    { id: 7, name: 'Findit', tech: ['rails', 'ruby', 'javascript'] },
    { id: 8, name: 'Tidder', tech: ['rails', 'javascript', 'ruby'] },
    { id: 9, name: 'NodejsChatgpt', tech: ['node.js', 'javascript'] },
    { id: 10, name: 'Tenzies', tech: ['react', 'javascript'] },
                ...
                <div id="portfolio--header">
                    ...
                    <div id='portfolio--filters'>
                        ...
                        <button
                         onClick={handleTechButtonClick} 
                         value="react native" 
                         className={selectedTech.includes('react native') ? 'selected' : ''}
                        >
                          React Native
                        </button>
                        <button
