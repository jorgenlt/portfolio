            ...
            >
                ...
                <Modal.Body>
                    <div class="projects-modal--body">
                                ...
                                <div>
                                    ...
                                    <div class="">
                                        <a href="https://notes-app.jorgenlt.me" target="_blank" rel="noopener noreferrer">
                                            <img src="/images/notes-app-desktop.png" alt="Notes app" class="projects-modal--full-img" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="other-projects--wrapper">
                        <h1 class="mt-0">Meme Generator</h1>
                        <div class="other-projects--description">
                            <div>
                            ...
                            <div class="other-projects--description">
                                <div>
                                    ...
                                    <a href="https://codepen.io/dogonscooter/full/JjaxOwp" target="_blank" rel="noopener noreferrer">
                                        <img src="/images/pomodoro_timer.png" alt="Pomodoro Timer" class="projects-modal--full-img" />
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="other-projects--description">
                                <div>
                                    ...
                                    <a href="https://codepen.io/dogonscooter/full/vYzVdbQ" target="_blank" rel="noopener noreferrer">
                                        <img src="/images/javascript_calculator.png" alt="" class="projects-modal--full-img" />
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="other-projects--description">
                                <div>
                                    ...
                                    <a href="https://codepen.io/dogonscooter/full/XWPEmpX" target="_blank" rel="noopener noreferrer">
                                        <img src="/images/choropleth_map.png" alt="Choropleth Map" class="projects-modal--full-img" />
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="other-projects--description">
                                <div>
                                    ...
                                    <a href="https://codepen.io/dogonscooter/full/OJovJpB" target="_blank" rel="noopener noreferrer">
                                        <img src="/images/heat_map.png" alt="Heat Map" class="projects-modal--full-img" />
                                    </a>
                                </div>
                            </div>
                        </div>
