          ...
          <div className="projects-modal--body">
            <div className="projects-modal--lede">
              <div>
                ...
                <p>
                  <a
                    href="https://github.com/jorgenlt/spotify-artist-page"
                    target="_blank"
                  >
                    View on GitHub
                  </a>
            ...
            <div className="projects-modal--media">
              <div className="media--spotify-desktop">
                <img
                  src="/images/spotify-desktop.png"
                  alt="Spotify on desktop."
                />
                <img
                  src="/images/spotify-desktop2.png"
                  alt="Spotify on desktop."
                />
              </div>
            </div>
            <div>
              ...
              <p className="mt-4 mb-2">Text with code below.</p>
              <SyntaxHighlighter
                language="javascript"
                style={tomorrowNightBright}
              >
