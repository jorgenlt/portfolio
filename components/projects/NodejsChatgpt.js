          ...
          <div className="projects-modal--body">
            <div className="projects-modal--lede">
              <div>
                ...
                <p>
                  <a
                    href="https://github.com/jorgenlt/nodejs-chatgpt"
                    target="_blank"
                  >
                    View on GitHub
                  </a>
            ...
            <div className="projects-modal--media">
              <div className="media--desktop">
                <img
                  src="/images/nodejs-chatgpt-gif.gif"
                  alt="Demo of Node.js ChatGPT CLI"
                />
              </div>
            </div>
            <div>
              ...
              <ul>
                <li>
                  <i className="fa-solid fa-circle-arrow-right"></i>Communicate
                  with ChatGPT directly from the terminal.
                </li>
                <li>
                  <i className="fa-solid fa-circle-arrow-right"></i>Fast and
                  secure.
                </li>
                <li>
                  <i className="fa-solid fa-circle-arrow-right"></i>With BASH
                  script to make an alias for quick execution.
                </li>
                <li>
                  <i className="fa-solid fa-circle-arrow-right"></i>Chat history
                  for current session is transferred with every prompt.
                </li>
              </ul>
