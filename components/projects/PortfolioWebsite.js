          ...
          <div className="projects-modal--body">
            <div className="projects-modal--lede">
              <div>
                ...
                <p>
                  <a
                    href="https://github.com/jorgenlt/portfolio"
                    target="_blank"
                  >
                    View on GitHub
                  </a>
            ...
            <div className="projects-modal--media">
              <div className="media--desktop">
                <img
                  src="/images/portfolio-website-desktop2.png"
                  alt="Screeshot, Portfolio website."
                  style={{ boxShadow: "1px 1px 30px 0px #20202087" }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <ul>
                <li>
                  <i className="fa-solid fa-circle-arrow-right"></i>Portfolio
                  website with resume and projects.
                </li>
              </ul>
              ...
              <p>
                ...
                framework. The website is additionally supported by Webpack,
                Bootstrap, SASS,{" "}
                <a
              ...
              <p>
                The portfolio section with the portfolio cards and the feature
                to filter by technology.
              </p>
              <SyntaxHighlighter
                language="javascript"
                style={tomorrowNightBright}
              ...
              <p>
                An example of how the project modals are made. Here shown with
                Smartbot.js
              </p>
              <SyntaxHighlighter
                language="javascript"
