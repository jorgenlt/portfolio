          ...
          <div className="projects-modal--body">
            <div className="projects-modal--lede">
              <div>
                ...
                <p><a href="https://github.com/jorgenlt/photo-gallery" target="_blank">View on GitHub</a></p>
              </div>
            </div>
            <div className="projects-modal--media">
              <div className='media--desktop'>
                <a href="https://photography.jorgenlt.me" target="_blank">
                  <img src="/images/photo-gallery-desktop2.jpg" alt="Photo Gallery on desktop." />
                </a>
              </div>
              <div className='media--mobile'>
                <img src="/images/photo-gallery-mobile.png" alt="Photo Gallery on mobile." />
                <img src="/images/photo-gallery-mobile2.png" alt="Photo Gallery on mobile." />
              </div>
            </div>
            <div>
              <h2>Features</h2>
              ...
              <ul>
              <li><i className="fa-solid fa-circle-arrow-right"></i>Enable sign up.</li>
              <li><i className="fa-solid fa-circle-arrow-right"></i>A user can create their own personal portfolio.</li>
              <li><i className="fa-solid fa-circle-arrow-right"></i>A user can CRUD categories and sub-categories.</li>
              <li><i className="fa-solid fa-circle-arrow-right"></i>Visitors can like(vote) a picture.</li>
              </ul>
            </div>
          </div>
        </Modal.Body>
