...
import { smartbotCode1, smartbotCode2, smartbotCode3, smartbotCode4, smartbotCode5 } from '@/components/code-snippets/smartbotCode';
        ...
        >
          <Modal.Header>
            ...
            <span className='modal-close' onClick={handleClose}>
              <i className="fa-solid fa-xmark hover-brighter-green">
            </i></span>
          </Modal.Header>
          <Modal.Body>
            <div className="projects-modal--body">
              <div className="projects-modal--lede">
                ...
                <div className="projects-modal--media">
                  <div>
                    <img className="smartbot-mobile" src="/images/smartbot-mobile-frame4.png" alt="Smartbot screenshot" />
                    <img className="smartbot-mobile" src="/images/smartbot-mobile-frame2.png" alt="Smartbot screenshot" />
                    <img className="smartbot-mobile" src="/images/smartbot-mobile-frame1.png" alt="Smartbot screenshot" />
                    <img className="smartbot-mobile" src="/images/smartbot-mobile-frame3.png" alt="Smartbot screenshot" />
                  </div>
                </div>
                <div>
                  <h2>Features</h2>
                  <ul>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Acess to a powerful conversational AI with 
                    the <a href="https://platform.openai.com/docs/introduction" target="_blank">OpenAI API</a></li>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Create, browse and delete conversations</li>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Continue an earlier conversation</li>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Copy a message to clipboard</li>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Share a message</li>
                  </ul>
                  ...
                  <ul>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Dark mode</li>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Personal account with authentication.</li>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Database storage of conversations (Firebase)</li>
                    <li><i className="fa-solid fa-circle-arrow-right"></i>Option to add OpenAI API key manually and change model.</li>
                  </ul>
                </div>
            </div>
          </Modal.Body>
